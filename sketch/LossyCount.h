#ifndef LossyCount_H //must change this MACRO
#define LossyCount_H //must change this MACRO
...
class LossyCount: public SketchBase {
private:
	/*----optional according to your need----*/
	LC_type * result;
	double * phi;
...
public:
    ...
    LossyCount()
    {
        ...
        sketch_name =  "LossyCount";//please keep sketch_name the same as class name and .h file name
    }
